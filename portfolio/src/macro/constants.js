...
export const PROPS = {
    MUG: [9, DESK_TOP_Y, -1.5],
    PLANT: [11, DESK_TOP_Y, 5.5],
    LAPTOP: [-3.2, DESK_TOP_Y, -5.5],
    CABLE_PATH: [
        [-3.2, 0.45, -4.2],
        [-0.5, 0.45, -3.0],
        [2.5, 0.45, -2.0],
    ...
    STICKY_NOTES: [
        { pos: [2, DESK_TOP_Y, 2], rotY: 0.15, color: "#ffe066", text: "fix the bug" },
        { pos: [-2.5, DESK_TOP_Y, 3], rotY: -0.25, color: "#a8e6a3", text: "buy milk" },
        { pos: [6, DESK_TOP_Y, 3.5], rotY: 0.4, color: "#ffaaaa", text: "ship pocketproof" },
    ],
    AVATAR_NOTE: { pos: [-5.5, DESK_TOP_Y, 1], rotY: 0.1, text: "this is me" },
};
export const LAMP = {
    // Position the desk lamp at the back-left of the desk
    POSITION: [-9, DESK_TOP_Y, -5],
    ARM_LENGTH: 2.4,
    HEAD_HEIGHT: 3.4,
    WARM: "#ffd9a8",
    CONE_INTENSITY: 14,
