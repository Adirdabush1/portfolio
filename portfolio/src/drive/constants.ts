...
export const CAR = {
  ...
  MASS: 3.5,
  MAX_SPEED: 23,
  SPAWN: [0, 1.5, 6] as Vector3Tuple,
};

export const CAMERA = {
  OFFSET: [0, 5.2, 11] as Vector3Tuple,
  LOOK_AHEAD: 3.5,
  POS_LERP: 0.08,
  LOOK_LERP: 0.12,
};
...
export const BILLBOARDS: BillboardConfig[] = [
  // Hero zone (North)
  {
    id: "hero",
    label: "Adir Dabush",
...
export const PROPS = {
  ...
  RAMPS: [
    { pos: [0, 0, -25] as Vector3Tuple, rot: 0 },
    { pos: [25, 0, 0] as Vector3Tuple, rot: Math.PI / 2 },
    { pos: [0, 0, 25] as Vector3Tuple, rot: 0 },
    { pos: [-25, 0, 0] as Vector3Tuple, rot: Math.PI / 2 },
  ],
  // cones in clusters
